      ...
      <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
        <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-8">
          {servicesData.map((feature) => (
            <div key={feature.name} className="relative pl-16 bg-[#00000015] dark:bg-[#ffffff15] py-4 pr-4 rounded-xl">
              <dt className="text-base font-semibold leading-10 tracking-wider">
              ...
              <dd className="mt-2 text-base leading-10 text-gray-500 dark:text-gray-400">
                {feature.description}
              </dd>
            </div>
          ))}

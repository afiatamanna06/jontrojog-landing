...
export default function About() {
  return (
    <div id="about" className="relative mx-auto max-w-7xl px-6 lg:px-8 mb-12 lg:mb-40">
      <img
        className="w-full bg-gray-50 object-cover rounded-xl pt-28 lg:absolute lg:inset-y-0 lg:left-0 lg:h-full lg:w-1/2"
